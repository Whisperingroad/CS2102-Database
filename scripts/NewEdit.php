...
<?php
    ...
    $sql = "SELECT post_title, post_content , post_time, post_username, pvotes  FROM POST_WRITEPOST WHERE post_title = '".$_SESSION['post_title']."'  AND post_username = '".$_SESSION['post_username']."'

...
comment_time TIMESTAMP(0) with local time zone DEFAULT CURRENT_TIMESTAMP,
post_username VARCHAR(32),
post_title VARCHAR(32),
post_time TIMESTAMP(0) with local time zone,
FOREIGN KEY (post_username, post_title, post_time) REFERENCES post_writepost( post_username, post_title, post_time) ON DELETE CASCADE,
...
comment_time TIMESTAMP(0) with local time zone,
post_username VARCHAR(32),
post_title VARCHAR(32),
post_time TIMESTAMP(0) with local time zone,
FOREIGN KEY (comment_username, comment_time,post_username, post_title, post_time) REFERENCES contains_comments (comment_username, comment_time, post_username, post_title, post_time) ON DELETE CASCADE,
...
post_title VARCHAR(32),
post_username VARCHAR(32),
FOREIGN KEY(post_time,post_title, post_username) REFERENCES post_writepost(  post_time,post_title, post_username) ON DELETE CASCADE,
FOREIGN KEY(voter_username) REFERENCES REGISTERED_USER(username),
PRIMARY KEY(post_time, post_title, post_username, voter_username)
);
...
FOREIGN KEY (post_title, post_time,post_username) REFERENCES post_writepost(post_title, post_time,post_username) ON DELETE CASCADE, 
...
voter_username VARCHAR(32),
FOREIGN KEY (voter_username) REFERENCES Registered_User(username),
FOREIGN KEY (comment_time, comment_username, post_username, post_title, post_time) references write_comments(comment_time, comment_username, post_username, post_title, post_time) ON DELETE CASCADE,
PRIMARY KEY (comment_username, comment_time, post_username, post_title, post_time, voter_username, hasVoted)
);
